...
import (
	...
	"github.com/everpeace/kube-throttler/pkg/generated/clientset/versioned/scheme"
	rest "k8s.io/client-go/rest"
)

type ScheduleV1alpha1Interface interface {
	RESTClient() rest.Interface
	ClusterThrottlesGetter
	ThrottlesGetter
}
...
func (c *ScheduleV1alpha1Client) ClusterThrottles() ClusterThrottleInterface {
	return newClusterThrottles(c)
}

func (c *ScheduleV1alpha1Client) Throttles(namespace string) ThrottleInterface {
	return newThrottles(c, namespace)
}
...
// NewForConfigAndClient creates a new ScheduleV1alpha1Client for the given config and http client.
// Note the http client provided takes precedence over the configured transport values.
func NewForConfigAndClient(c *rest.Config, h *http.Client) (*ScheduleV1alpha1Client, error) {
	config := *c
	if err := setConfigDefaults(&config); err != nil {
		return nil, err
	}
