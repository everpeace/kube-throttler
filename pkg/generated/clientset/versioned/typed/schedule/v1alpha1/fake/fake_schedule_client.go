...
import (
	v1alpha1 "github.com/everpeace/kube-throttler/pkg/generated/clientset/versioned/typed/schedule/v1alpha1"
...
func (c *FakeScheduleV1alpha1) ClusterThrottles() v1alpha1.ClusterThrottleInterface {
	return &FakeClusterThrottles{c}
}

func (c *FakeScheduleV1alpha1) Throttles(namespace string) v1alpha1.ThrottleInterface {
	return &FakeThrottles{c, namespace}
}
